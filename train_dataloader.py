...
def dataloaders(device):
    ...
    train_loader_2 = torch.utils.data.DataLoader(train_dataset, batch_size=1,
                                          shuffle=True)

    dev_loader_train = torch.utils.data.DataLoader(dev_dataset, batch_size=dev_batch_size_train,
                                          shuffle=True)
